...
public class HipchatTests
{
    ...
    @Test
	public void testCreateAndDeleteRooms() throws InterruptedException
	{
		HipChat hipchat = new HipChat(HIPCHAT_KEY);
		...
		// From jaysee00: There seems to be a minor delay between when a 
		// room is deleted and the deletion is reflected in the next call to listRooms().
		Thread.sleep(2000);
